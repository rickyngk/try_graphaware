...
public class ModuleIntegrationTest extends WrappingServerIntegrationTest {
    ...
    public void shouldRecommendRealTime() {
        try {
            ...
            String expectedForVince = "Computed recommendations for Vince: (Adam {total:41.99417, ageDifference:-5.527864, friendsInCommon:{value:27.522034, {value:1.0, name:Jim}, {value:25.522034, ParetoTransformationOf:2.0}, {value:1.0, name:Michal}}, sameGender:10.0, sameLocation:{value:10.0, {value:10.0, location:London}}}), (Luanne {total:7.856705, ageDifference:-7.0093026, friendsInCommon:{value:14.866008, {value:13.866008, ParetoTransformationOf:1.0}, {value:1.0, name:Michal}}})";
            ...
            String expectedForAdam = "Computed recommendations for Adam: (Vince {total:41.99417, ageDifference:-5.527864, friendsInCommon:{value:27.522034, {value:1.0, name:Jim}, {value:25.522034, ParetoTransformationOf:2.0}, {value:1.0, name:Michal}}, sameGender:10.0, sameLocation:{value:10.0, {value:10.0, location:London}}}), (Daniela {total:19.338144, ageDifference:-5.527864, friendsInCommon:{value:14.866008, {value:13.866008, ParetoTransformationOf:1.0}, {value:1.0, name:Michal}}, sameLocation:{value:10.0, {value:10.0, location:London}}})";
